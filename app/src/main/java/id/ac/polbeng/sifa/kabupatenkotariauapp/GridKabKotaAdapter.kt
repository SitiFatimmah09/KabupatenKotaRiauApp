package id.ac.polbeng.sifa.kabupatenkotariauapp

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import id.ac.polbeng.sifa.kabupatenkotariauapp.databinding.ItemListKabkotaBinding
...
class GridKabKotaAdapter(private val listKabKota: ArrayList<KabKota>):
    ...
    inner class GridViewHolder(val binding: ItemListKabkotaBinding): RecyclerView.ViewHolder(binding.root)
}